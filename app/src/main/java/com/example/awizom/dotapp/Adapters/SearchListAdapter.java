...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.OrderItemViewHolder> {
    ...
    public SearchListAdapter(Context mCtx, List<DataOrder> orderitemList, String filterKey, String valueButtonname, String statusName) {
        this.mCtx = mCtx;
